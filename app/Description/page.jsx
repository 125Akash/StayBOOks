...
const Description = () => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center items-center mx-auto mb-6">
      ...
      <div className="flex justify-center items-center mt-8">
        <button
          ...
          className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full mb-12"
        >
          <Link href="/EndPage">Save Data</Link>
        </button>
      </div>
    </>
  );
